          ...
          <TabPanels py="0">
            ...
            <TabPanel py="0">
              ...
              >
                ...
                <Text pt="10px" pb="30px" color="#7F8B9F">
                  Agora, insira abaixo o código de 6 dígitos que enviamos para
                  jo*********va@gmail.com
                </Text>
                <Flex w="100%">
                  <HStack>
                  ...
                  <Box pl="20px">
                    ...
                    <Text fontWeight={700} color="#2E4EFF">
                      REENVIAR CÓDIGO
                    </Text>
                  </Box>
                </Flex>
            ...
            <TabPanel py="0">
              ...
              >
                ...
                <Text pt="10px" pb="30px" color="#7F8B9F">
                  Queremos saber mais sobre o seu negócio. Nos informe alguns
                  dados pra identificar a sua empresa
                </Text>
                <SimpleGrid columns={4} gap={5}>
                  <GridItem colSpan={2}>
                    <Input
            ...
            <TabPanel py="0">
              ...
              >
                ...
                <Text pt="10px" pb="30px" color="#7F8B9F">
                  Agora, precisamos de alguns documentos para validação da sua
                  empresa
                </Text>
                <SimpleGrid columns={4} gap={5}>
                  <GridItem colSpan={2}>
            ...
            <TabPanel py="0">
              ...
              >
                ...
                <Text borderTop="1px" borderColor="#CBD3E0" mt="40px" py="25px">
                  ENDEREÇO:
                </Text>
                <SimpleGrid columns={4} gap={5}>
                  <GridItem colSpan={2}>
            ...
            <TabPanel py="0">
              ...
              >
                ...
                <Text pt="10px" pb="30px" color="#7F8B9F">
                  Agora que a gente já te conhece, só falta você cadastrar uma
                  boa senha, pra garantir a segurança dos seus dados
                </Text>
                <Box w="40%">
                  <Input
                    label="Senha"
